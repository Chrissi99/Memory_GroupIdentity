...
PARTICIPANT_FIELDS = ['test_id', 'id_worked',
                      ...
                      'group_ref', 'belief_ref', 'group_ref_background',
                      'task_rounds', 'treat_first', 'task_order',
                        'task1', 'task2', 'score_logic', 'score_luck',
                      'expiry', 'belief_example_value', 'belief_example_direction',
                      'attention1_passed', 'prior_logic', 'prior_luck',
                      'prior_bonus_task', 'prior_bonus',
                      #'prior_sel_q',
                      #  'post_sel_q', 'post_bonus',
                      #  'prob_logic_post2', 'prob_effort_post2', 'prob_luck_post2',
                        'post2_first', 'post2_second',
                      ...
                      'r1_sign', 'r2_sign', 'logic_sign_shown', 'luck_sign_shown',
                        'logic_sig_good_transf', 'luck_sig_good_transf',
                      'signals_pos', 'signals_neg',
                      'mistake_rep', 'mistake_prob',
                      'post_logic', 'post_luck',
                      'post_bonus_task', 'post_bonus',
                        'group2', 'outgroup2', 'group_state2',
                        'post2_logic', 'post2_luck',
                      'post2_bonus_task', 'post2_bonus',
                      'recall_logic',  'recall_luck',
                      'recall_logic_correct', 'recall_luck_correct',
